...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
      <img class="animation__shake" src="dist/img/awlogo.png" alt="AdminLTELogo" height="60" width="60">
    </div>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="pages/tables/datast.html" class="nav-link">
                    <i class="nav-icon fas fa-table"></i>
                    <p>Table</p>
                  </a>
                </li>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="pages/tables/datact.html" class="nav-link">
                    <i class="nav-icon fas fa-table"></i>
                    <p>Table</p>
                  </a>
                </li>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="pages/tables/datacc.html" class="nav-link">
                    <i class="nav-icon fas fa-table"></i>
                    <p>Table</p>
                  </a>
                </li>
